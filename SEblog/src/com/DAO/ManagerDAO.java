...
public class ManagerDAO {
	...
	public void deleteBlog(int blogId) {
		...
		DBConnection.instance.executeQuery(DELETE_ALL_COMMENTS_BY_OBJECTID, params);  //删除博客的评论
		DBConnection.instance.executeQuery(DELETE_BLOG, params);  //删除博客
		DBConnection.instance.executeQuery(DELETE_USER_BLOG_RELATION, params);  //删除用户和博客的关系
	};
