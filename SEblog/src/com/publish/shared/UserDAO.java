...
import com.publish.client.Blog;
import com.publish.client.Comment;
import com.publish.client.Message;
...
public class UserDAO {
	...
	//�û��Լ��Ĳ���
	private static final String INSERT_BLOG_INFO = "INSERT INTO `blog_info` VALUES(0,?,?,?,?,0,0,0,0,?)";
